        ...
        <div class="row"> 
          ...
          <div class="col-md-4">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="numero_de_expediente" name="numero_de_expediente" required>
            </div>
            <div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="date" class="form-control" id="fecha_parte" name="fecha_parte" value="<?php echo $fechaActual; ?>" required>
			</div>

            <div class="mb-3">
              <label for="tipo" class="form-label">Tipo</label>
              <select class="form-select" id="tipo" name="tipo">
                <option value="0">Siniestro</option>
          ...
          <div class="col-md-8">
            <div class="mb-3">
              ...
              <sup style="font-size: 20px;color:#990000;top: -2px;">*</sup>
              <select class="form-select" id="id_profesional" name="id_profesional" required>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="abre_nueva_asistencia" name="abre_nueva_asistencia">
                <option value="No se abre otra sistencia" selected>Seleccione una opción</option>
                <option value="Por profesional">Por profesional</option>
                <option value="Por oficina">Por oficina</option>
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="descripcion_del_trabajo" name="descripcion_del_trabajo" rows="3"></textarea>
            </div>
            <!-- Campo para codigos -->
            <div class="mb-3">
              ...
              <div class="row"> 
                ...
                <div class="col-md-6">
                  <div class="mb-3 d-flex align-items-center">
                    ...
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="interviene_taller" name="interviene_taller">
                    </div>
                  </div>
                  <div class="mb-3 d-flex align-items-center">
                    <label for="ofrece_asistencia" class="form-label mb-0 me-2">Ofrece asistencia</label>
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="ofrece_asistencia" name="ofrece_asistencia">
                    </div>
                  </div>
                  <div class="mb-3 d-flex align-items-center">
                    <label for="felicitacion" class="form-label mb-0 me-2">Felicitación</label>
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="felicitacion" name="felicitacion">
                    </div>
                  </div>
                </div>
                <!-- Columna derecha -->
                <div class="col-md-6">
                  <div class="mb-3 d-flex align-items-center">
                    ...
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="ha_realizado_fotos" name="ha_realizado_fotos">
                    </div>
                  </div>
                  <div class="mb-3 d-flex align-items-center">
                    <label for="hay_que_limpiar" class="form-label mb-0 me-2">Hay que limpiar</label>
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="hay_que_limpiar" name="hay_que_limpiar">
                    </div>
                  </div>
                  <div class="mb-3 d-flex align-items-center">
                    <label for="ha_limpiado" class="form-label mb-0 me-2">Ha limpiado</label>
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="ha_limpiado" name="ha_limpiado">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="reclamacion" name="reclamacion">
            </div>
            <div class="mb-3">

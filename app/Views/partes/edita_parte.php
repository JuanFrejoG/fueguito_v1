<div class="container-fluid">
  <div class="dashboard-container">
    <div class="container mt-4">
      <h2>Detalle Parte</h2>
      <form action="<?= site_url('partes/actualizar') ?>" method="post">
        ...
        <div class="row"> 
          ...
          <div class="col-md-4">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="numero_de_expediente" name="numero_de_expediente" value="<?=$parte['numero_de_expediente'];?>"  >
            </div>
            <div class="mb-3">
              <label for="nombre" class="form-label">Nombre</label>
              <input type="text" class="form-control" id="nombre" name="nombre"   value="<?=$parte['nombre'];?>">
            </div>
            <div class="mb-3">
              <label for="telefono" class="form-label">Teléfono</label>
              <input type="text" class="form-control" id="telefono" name="telefono"   value="<?=$parte['telefono'];?>">
            </div>
            <div class="mb-3">
              <label for="direccion" class="form-label">Dirección <sup style="font-size: 20px;color:#990000;top: -2px;">*</sup></label>
              <input type="text" class="form-control" id="direccion" name="direccion"   value="<?=$parte['direccion'];?>">
            </div>
            <div class="mb-3">
    ...
    <select class="form-select" id="localidad" name="localidad"  >
        ...
        <?php endforeach; ?>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="cp" name="cp"   value="<?=$parte['cp'];?>">
            </div>
			<?php
			...
			<div class="mb-3">
				...
				<input type="date" class="form-control" id="fecha_parte" name="fecha_parte" value="<?=$parte['fecha_parte'];?>"  >
			</div>
            ...
            <div class="mb-3">
              ...
              <sup style="font-size: 20px;color:#990000;top: -2px;">*</sup>
              <input type="number" class="form-control" id="importe" name="importe" step="0.01"   value="<?=$parte['importe'];?>" required>
            </div>
            <div class="mb-3">
          ...
          <div class="col-md-8">
            <div class="mb-3">
              ...
              <sup style="font-size: 20px;color:#990000;top: -2px;">*</sup>
              <select class="form-select" id="id_profesional" name="id_profesional"  >
    ...
    <?php endforeach; ?>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="id_profesional2" name="id_profesional2"  >
                <option value="">Seleccione un Empleado</option>
                <?php foreach($empleados as $empleado): ?>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="id_profesional3" name="id_profesional3"  >
                  <option value="">Seleccione un Empleado</option>
                  <?php foreach($empleados as $empleado): ?>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="id_profesional4" name="id_profesional4"  >
                  <option value="">Seleccione un Empleado</option>
                  <?php foreach($empleados as $empleado): ?>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" id="id_profesional5" name="id_profesional5"  >
                  <option value="">Seleccione un Empleado</option>
                  <?php foreach($empleados as $empleado): ?>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="empleado_comision" name="empleado_comision"  >
                <option value="">Seleccione un Empleado</option>
                <?php foreach($empleados as $empleado): ?>
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="abre_nueva_asistencia" name="abre_nueva_asistencia"  >
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="descripcion_del_trabajo" name="descripcion_del_trabajo" rows="3"   ><?=$parte['descripcion_del_trabajo'];?></textarea>
            </div>
            <!-- Campo para codigos -->
            <div class="mb-3">
              <label for="codigos" class="form-label">Códigos</label>
              <input type="text" class="form-control" id="codigos" name="codigos"   value="<?=$parte['codigos'];?>">
            </div>
    ...
    <div class="form-switch">
        <input type="checkbox" class="form-check-input" id="interviene_taller" name="interviene_taller" <?= $parte['interviene_taller'] ? 'checked' : ''; ?>  >
    </div>
</div>
                  ...
                  <div class="mb-3 d-flex align-items-center">
                    ...
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="ofrece_asistencia" name="ofrece_asistencia" <?= $parte['ofrece_asistencia'] ? 'checked' : ''; ?>  >
                    </div>
                  </div>
                  <div class="mb-3 d-flex align-items-center">
                    <label for="felicitacion" class="form-label mb-0 me-2">Felicitación</label>
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="felicitacion" name="felicitacion" <?= $parte['felicitacion'] ? 'checked' : ''; ?>  >
                    </div>
                  </div>
                </div>
                <!-- Columna derecha -->
                <div class="col-md-6">
                  <div class="mb-3 d-flex align-items-center">
                    ...
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="ha_realizado_fotos" name="ha_realizado_fotos" <?= $parte['ha_realizado_fotos'] ? 'checked' : ''; ?>  >
                    </div>
                  </div>
                  <div class="mb-3 d-flex align-items-center">
                    <label for="hay_que_limpiar" class="form-label mb-0 me-2">Hay que limpiar</label>
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="hay_que_limpiar" name="hay_que_limpiar" <?= $parte['hay_que_limpiar'] ? 'checked' : ''; ?>  >
                    </div>
                  </div>
                  <div class="mb-3 d-flex align-items-center">
                    <label for="ha_limpiado" class="form-label mb-0 me-2">Ha limpiado</label>
                    <div class="form-switch">
                      <input type="checkbox" class="form-check-input" id="ha_limpiado" name="ha_limpiado" <?= $parte['ha_limpiado'] ? 'checked' : ''; ?>  >
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="reclamacion" name="reclamacion" value="<?=$parte['reclamacion'];?>"  >
            </div>
            <div class="mb-3">
              <label for="observaciones" class="form-label">Observaciones</label>
              <textarea class="form-control" id="observaciones" name="observaciones" rows="3"  ><?=$parte['observaciones'];?></textarea>
            </div>
